 ...
 * type : 1购物车 2立即购买
 */
function addToCart(id,gtype,type,form)
{
    if(id<1)
    {
        showPageLoadingMsg("你还未选择商品");
        return false;
    }
    var url = '';

    showPageLoadingMsg('处理中,请稍候...');
    $.get(url+'/cart/add.html?in_ajax=1',{id:id,gtype:gtype},function(res){
        if(res.status == 1)
        {
            if(type == 2)
            {
                window.location.href=url +"/cart/list.html";
                return false;
            }
            else
            {
        ...
        $('.ui-loader').hide();
        floatNotify.simple(res.msg, "", 2e3);
        return false;
    },'json');
}
//$(function(){
//    $(document).on('click','a.link',function(){
//        showPageLoadingMsg('加载中...');
//        setTimeout("$('.ui-loader').remove();",2500);
//        window.location.href = $(this).attr('href');
//        return false;
//    })
//})
/*document.addEventListener('WeixinJSBridgeReady', function onBridgeReady() {
    WeixinJSBridge.call('hideOptionMenu');//隐藏微信中分享按钮
});*/
